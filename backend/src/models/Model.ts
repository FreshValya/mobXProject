...
export class Model {
  ...
  public static async deleteBy<Payload extends Record<string, any>>(payloadL: Payload): Promise<number> {
    return this.table.where(payloadL).del();
  }
